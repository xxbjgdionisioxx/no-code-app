    ...
    <div class="builder-panel-left">
        ...
        <div class="px-3 pb-3">
            <a href="<?= APP_URL ?>/apps/<?= $app['id'] ?>/modules/<?= $module['id'] ?>/delete"
               ...
               data-confirm="WARNING: This will delete the module '<?= htmlspecialchars($module['name']) ?>' and ALL its stored records permanently! Are you sure?">
            ...
            <div class="field-card" data-field-id="<?= $field['id'] ?>" draggable="true">
                ...
                <div class="field-card-actions">
                    ...
                    <a href="<?= APP_URL ?>/apps/<?= $app['id'] ?>/modules/<?= $module['id'] ?>/fields/<?= $field['id'] ?>/delete"
                       ...
                       data-confirm="Delete the field '<?= htmlspecialchars($field['name']) ?>'? All stored values for this field will be lost.">
